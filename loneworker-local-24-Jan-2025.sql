...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2025 at 03:56 PM
...
(1, 'admin', 'admin', 'admin@loneworker.com', 'admin@loneworker.com', '1234567890', '0987654321', 'Lone Worker', NULL, NULL, 'default.png', 'admin', '2025-01-24 13:22:23', '2025-01-24 13:22:23');
...
(21, 'kashifkhan@gmail.com', 'Basic Plan', '<p>Basic Plan</p><p><br></p>', 'paid', '50', '1500', 'yearly', 100, 'active', '2025-01-18 13:01:32', NULL),
...
CREATE TABLE `users` (
  ...
  `designation` varchar(100) DEFAULT NULL,
  `user_image` varchar(100) DEFAULT NULL,
  `user_type` varchar(10) DEFAULT 'subscriber',
  `added_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_on` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `username`, `role`, `email`, `password`, `cell_no`, `phone_no`, `company_name`, `official_address`, `designation`, `user_image`, `user_type`, `added_on`, `updated_on`) VALUES
(2, 'Muhammad Junaid Qureshi', 'monitor', 'junaidfaraz79@gmail.com', 'junaidfaraz79@gmail.com', '435345345', '7894561231', 'Test Company', 'Test address', 'Manager', '', 'subscriber', '2025-01-03 20:22:31', '2025-01-18 10:37:56'),
(3, 'Test User', 'monitor', 'testuser@gmail.com', 'testuser@gmail.com', '020 7123 4567', '+44 117 2345678', '', '', '', NULL, 'subscriber', '2025-01-07 17:41:58', '2025-01-18 10:37:58'),
(4, 'Junaid', 'monitor', 'junaidfaraz80@gmail.com', 'password', NULL, '534534543', 'Test Company', 'Test address', 'Manager', NULL, 'user', '2025-01-18 12:01:06', NULL),
(18, 'Kashif', 'monitor', 'kashifkhan@gmail.com', 'password', '535435353', '353535', 'Test Company', 'Test address', 'Manager', NULL, 'user', '2025-01-18 13:01:32', NULL),
(19, 'Adnan', 'monitor', 'adnan79@gmail.com', 'password', '343322', '3424234', 'Test Company', 'Test address', 'Manager', NULL, 'user', '2025-01-18 14:48:21', NULL),
(20, 'Danish Khan', 'monitor', 'danishkhan7911@gmail.com', 'password', '3423423', '4434344345', 'Test Company', 'Test address', 'Manager', NULL, 'user', '2025-01-18 15:23:50', NULL);
...
(20, 'Bisma Imran', '21343435', 'bisma@gmail.com', '', 'old', 'Worker', 'Security', 'No Timer', '', 'active', '2025-01-23 13:20:00', '2025-01-24 12:23:21');
