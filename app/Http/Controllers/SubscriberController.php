    ...
    public function updateCard(Request $req)
    {
        ...
        try {
            ...
            $cardData = [
                ...
                'cvv_cvc' => $validated['cvv_cvc'],
                'updated_at' => now(),
            ];

            // Update or insert the card record
            DB::table('cards')->updateOrInsert(
                ['subscriber_id' => $subscriberId], // Match condition
                $cardData // Data to insert/update
            );
