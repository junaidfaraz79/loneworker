				...
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<div class="app-sidebar-logo position-relative" id="kt_app_sidebar_logo">
						...
						<a href="{{ route('admin.dashboard') }}">
							...
							<img alt="Logo" src="/assets/media/logos/star-mini.svg"
					...
					<div class="app-sidebar-menu overflow-hidden">
						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper my-5">
							<!--begin::Menu scroll-->
							<div id="kt_app_sidebar_menu_scroll" class="hover-scroll-overlay-y my-5 mx-4"
								...
								<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-1"
									...
									<div data-kt-menu-trigger="click"
										class="menu-item menu-accordion {{ Route::is('plans') || Route::is('plan.add') || Route::is('plan.edit') ? 'here show' : '' }}">
										<!--begin:Menu link-->
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link {{ Route::is('plans') ? 'active here show' : '' }}"
													href="/lwadmin/plans">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link {{ Route::is('plan.add') ? 'active here show' : '' }}"
													href="/lwadmin/plan/add">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<!--begin:Menu item-->
									<div data-kt-menu-trigger="click"
										class="menu-item menu-accordion {{ Route::is('subscriptions') || Route::is('subscription.add') || Route::is('subscription.edit') ? 'here show' : '' }}">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-icon">
												<i class="ki-duotone ki-abstract-28 fs-1">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link {{ Route::is('subscriptions') ? 'active here show' : '' }}"
													href="/lwadmin/subscriptions">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<!--begin:Menu item-->
									<div data-kt-menu-trigger="click"
										class="menu-item menu-accordion {{ Route::is('admin.editPassword') ? 'here show' : '' }}">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-icon">
												<i class="ki-duotone ki-abstract-28 fs-1">
										...
										<div class="menu-sub menu-sub-accordion">
											<!--begin:Menu item-->
											<div data-kt-menu-trigger="click"
												class="menu-item menu-accordion mb-1 {{ Route::is('admin.editPassword') ? 'here show' : '' }}">
												<!--begin:Menu link-->
												<span class="menu-link">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link {{ Route::is('admin.editPassword') ? 'active here show' : '' }}"
															href="/lwadmin/edit-password">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
