				...
				<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px">
					...
					<div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-20">
						...
						<a href="/" class="py-2 py-lg-20">
							<img alt="Logo" src="assets/media/logos/company-logo.png"
								class="theme-light-show h-40px h-lg-80px" />
							<img alt="Logo" src="assets/media/logos/company-logo.png"
								class="theme-dark-show h-40px h-lg-80px" />
						</a>
						<!--end::Logo-->
						<!--begin::Title-->
						<h1 class="d-none d-lg-block fw-bold text-white fs-2qx pb-5 pb-md-10">Welcome to Lone Worker
						</h1>
						<!--end::Title-->
						<!--begin::Description-->
			...
			<div class="d-flex flex-column flex-lg-row-fluid py-10">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid">
					...
					<div class="w-lg-500px p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
							data-kt-redirect-url="{{ route('subscriber.dashboard') }}" action="#">
							@csrf
							<!--begin::Heading-->
							...
							@if (session('message'))
							<div>
								<p align="center" style="color:red;">{{ session('message') }}</p>
							</div>
							@endif
							<!--begin::Heading-->
							<!--begin::Input group-->
				...
				<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
					...
					<div class="d-flex flex-center fw-semibold fs-6">
						<a href="https://esolacetech.com" class="text-muted text-hover-primary px-2"
							target="_blank">About</a>
						<a href="https://esolacetech.com" class="text-muted text-hover-primary px-2"
							target="_blank">Support</a>
						<a href="https://esolacetech" class="text-muted text-hover-primary px-2"
