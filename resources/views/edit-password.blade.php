        ...
        <div id="kt_app_content" class="app-content px-lg-3">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/lwadmin/dashboard"
                    ...
                    {{-- If the user is authenticated but not as admin --}}
                    <form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/dashboard"
                        id="kt_new_password_form" action="/update-password">
                        @else
                        {{-- If the user is neither authenticated as admin nor as a regular user --}}
                        <script>
                            window.location.href = '/signin'; // Redirect them to the login page or any other appropriate action
                        </script>
                        @endif
                        {{-- <form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/dashboard"
                            id="kt_new_password_form" action="/update-password"> --}}
