				...
				<div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="d-none d-lg-block fw-bold text-white fs-2qx pb-5 pb-md-10">Welcome to Star HTML Pro</h1>
							<!--end::Title-->
							<!--begin::Description-->
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-600px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="form w-100"  method="POST" action="{{ route('register') }}" id="">
                            @csrf
								<!--begin::Heading-->
								<div class="mb-10 text-center">
									...
									<a href="authentication/sign-in/basic.html" class="link-primary fw-bold">Sign in here</a></div>
									<!--end::Link-->
								</div>
								<!--end::Heading-->
								<!--begin::Action-->
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-semibold fs-6">
							...
							<a href="https://keenthemes.com/products/star-html-pro" class="text-muted text-hover-primary px-2" target="_blank">Purchase</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
