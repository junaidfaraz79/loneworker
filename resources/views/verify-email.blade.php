			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20">
					...
					<a href="index.html" class="pt-lg-20 mb-12">
						<img alt="Logo" src="assets/media/logos/star.svg" class="theme-light-show h-40px h-lg-50px" />
						<img alt="Logo" src="assets/media/logos/star-dark.svg" class="theme-dark-show h-40px h-lg-50px" />
					</a>
					<!--end::Logo-->
					<!--begin::Logo-->
					...
					<!--end::Logo-->
					<!--begin::Message-->
					<div class="fs-3 fw-semibold text-muted mb-10">We have sent an email to 
...
@endif
					...
					<div class="text-center mb-10">
						<a href="{{route('signin')}}" class="btn btn-lg btn-primary fw-bold">Skip for now</a>
					</div>
					<!--end::Action-->
					<!--begin::Action-->
					<div class="fs-5">
						<span class="fw-semibold text-gray-700">Did’t receive an email?</span>
						<a href="authentication/sign-in/password-reset.html" class="link-primary fw-bold">Resend</a>
					</div>
					<!--end::Action-->
				</div>
				<!--end::Content-->
				<!--begin::Illustration-->
				<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-150px min-h-lg-350px" style="background-image: url(assets/media/illustrations/sigma-1/7.png)"></div>
				<!--end::Illustration-->
			</div>
