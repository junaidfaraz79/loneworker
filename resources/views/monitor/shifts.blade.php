                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <!--begin::Add user-->
                                    <a href="{{ route('shift.add') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            <td class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="{{ route('shift.view', ['parameter' => $shift->id]) }}" class="text-gray-800 text-hover-primary mb-1">{{ $shift->name }}</a>
                                                </div>
                                                <!--begin::User details-->
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('shift.edit', ['parameter' => $shift->id]) }}" class="menu-link px-3">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
